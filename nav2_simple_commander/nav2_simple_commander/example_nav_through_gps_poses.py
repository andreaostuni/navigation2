...
def main():
    ...
    initial_pose = GeoPoseStamped()
    initial_pose.header.frame_id = 'utm'
    initial_pose.header.stamp = navigator.get_clock().now().to_msg()
    initial_pose.pose.position.x = 45.06056498
    initial_pose.pose.position.y = 7.65478235
    ...
    goal_pose2.pose.position.x = 45.06041833
    goal_pose2.pose.position.y = 7.6546793
    ...
    goal_pose3.pose.position.x = 45.06032646
    goal_pose3.pose.position.y = 7.65461377
    ...
    while not navigator.isTaskComplete():
        ...
        if feedback and i % 5 == 0:
            ...
            if Duration.from_msg(feedback.navigation_time) > Duration(seconds=35.0):
                ...
                goal_pose4.pose.position.x = 45.06023031
                goal_pose4.pose.position.y = 7.65454673
